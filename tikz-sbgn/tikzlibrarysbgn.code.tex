...
\tikzset{
    font=\sffamily,
    macromolecule/.style={draw = black, shape = macromolecule, minimum height = 40pt, minimum width = 80pt, line width = 1pt},
    submacromolecule/.style={draw = black, shape = macromolecule, minimum height = 36pt, minimum width = 72pt, line width = 1pt},
    macromoleculemultimer/.style={draw = black, shape = macromoleculemultimer, minimum height = 40pt, minimum width = 80pt, line width = 1pt},
    unspecifiedentity/.style={draw = black, shape = unspecifiedentity, minimum height = 40pt, minimum width = 80pt, line width = 1pt},
    nucleicacidfeature/.style={draw = black, shape = nucleicacidfeature, minimum height = 40pt, minimum width = 80pt, line width = 1pt},
    nucleicacidfeaturemultimer/.style={draw = black, shape = nucleicacidfeaturemultimer, minimum height = 40pt, minimum width = 80pt, line width = 1pt},
    perturbation/.style={draw = black, shape = signal, signal to = nowhere, signal from = east and west, signal pointer angle = 110, minimum height = 40pt, minimum width = 80pt, line width = 1pt},
    simplechemical/.style={draw = black, shape = simplechemical, minimum height = 35pt, line width = 1pt},
    simplechemicalmultimer/.style={draw = black, shape = simplechemicalmultimer, minimum height = 35pt, minimum width = 80pt, line width = 1pt},
    complex/.style={draw = black, shape = complex, minimum height = 40pt, minimum width = 80pt, line width = 1pt},
    complexmultimer/.style={draw = black, shape = complexmultimer, minimum height = 40pt, minimum width = 80pt, line width = 1pt},
    ...
    entity/.style={draw = black, shape = macromolecule, minimum height = 40pt, minimum width = 80pt, line width = 1pt},
