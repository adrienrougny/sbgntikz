...
\tikzset{
    ...
    perturbation/.style={draw = black, shape = perturbation, minimum height = 40pt, minimum width = 80pt, line width = 1pt},
    ...
    complex/.style={draw = black, shape = comples, minimum height = 40pt, minimum width = 80pt, line width = 1pt},
    ...
    sv/.style={draw = black, fill = white, shape = rectangle, minimum width = 10pt, minimum height = 10pt, line width = 1pt, font = {\scriptsize\sffamily}},
