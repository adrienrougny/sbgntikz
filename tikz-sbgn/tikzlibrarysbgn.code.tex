...
%quasi copy of fit library code, written by Till Tantau
\pgfkeys{/tikz/subunits/.code=\tikz@lib@subunits{#1},
  /tikz/rotate subunits/.code=\def\tikz@lib@subunits@rotate{#1}\pgfkeysalso{/tikz/rotate=#1}}
