\pgfdeclareshape{simplechemicalmultimer}{
    ...
    \foregroundpath{
        ...
        \ifx\clone\true
            ...
            \circlefindx{\pgfpoint{\cax}{\cay}}{\radius}{\pgf@yc}{1}
            \pgfpathmoveto{\pgfpoint{\pgf@x}{\pgf@yc}}
            \circlefindx{\pgfpoint{\cbx}{\cby}}{\radius}{\pgf@yc}{2}
            \pgfpathlineto{\pgfpoint{\pgf@x}{\pgf@yc}}
            \circlefindangle{\pgfpoint{\cbx}{\cby}}{\radius}{\pgf@yc}{2}
            ...
            \circlefindangle{\pgfpoint{\cax}{\cay}}{\radius}{\pgf@yc}{1}
            ...
            \circlefindangle{\pgfpoint{\ccx}{\ccy}}{\radius}{\pgf@yb}{1}
            \pgfpatharc{\pgf@x}{-90}{\radius}
            \pgf@x=\xb
            \advance\pgf@x by -\radius
            \pgf@y=\ya
            ...
            \pgf@yc=\ya
            \advance\pgf@yc by \cloneoffset\height
            \circlefindangle{\pgfpoint{\cdx}{\cdy}}{\radius}{\pgf@yc}{2}
            \pgfpatharc{-90}{\pgf@x}{\radius}
            \circlefindx{\pgfpoint{\cbx}{\cby}}{\radius}{\pgf@yc}{2}
            \pgfpathlineto{\pgfpoint{\pgf@x}{\pgf@yc}}
            \circlefindangle{\pgfpoint{\cbx}{\cby}}{\radius}{\pgf@yc}{2}
            ...
            \advance\pgf@y by -\height
            \pgfpathlineto{\pgfpoint{\pgf@x}{\pgf@y}}
            \circlefindangle{\pgfpoint{\cax}{\cay}}{\radius}{\pgf@yb}{1}
            \pgfpatharc{-90}{\pgf@x}{\radius}
            \pgfpathclose
