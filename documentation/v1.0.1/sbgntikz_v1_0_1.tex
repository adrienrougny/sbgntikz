...
\tikzset{sbgn/.append style={execute at begin picture={
    ...
    \pgfsetlayers{background,compartments,includedcompartments,complexes,subcomplexes,main}}
    }
}
...
\title{sbgntikz}
\subtitle{manual for version 1.0}
...
\begin{code}
\draw[modulation=red!20] (0,0) -- (2cm,0);
\end{code}
...
\begin{code}
\draw[stimulation=red!20] (0,0) -- (2cm,0);
\end{code}
...
\begin{code}
\draw[necessary stimulation=red!20] (0,0) -- (2cm,0);
\end{code}
...
\begin{code}
\draw[catalysis] (0,0) -- (2cm,0);
\end{code}

The optional argument \colkey{<color>} can be used to set the fill color of the arc's tip:

\begin{code}
\draw[catalysis=red!20] (0,0) -- (2cm,0);
\end{code}
...
\begin{code}
\draw[absolute stimulation=red!20] (0,0) -- (2cm,0);
\end{code}
...
Hence, \sbgntikz{} defines and orders five layers: \colkey{background}, \colkey{compartments}, \colkey{complexes}, \colkey{subcomplexes} and \colkey{main} (default layer).
All compartments are drawn on the \colkey{compartments} layer, the complexes on the \colkey{complexes} layer, the complex subunits on the \colkey{subcomplexes} layer, and the rest on the \colkey{main} layer.
...
\tikzset{sbgn/.append style={execute at begin picture={
    \pgfdeclarelayer{includedcompartments}
    \pgfsetlayers{background,compartments,
        includedcompartments,complexes,subcomplexes,main}}
    }
}
\end{minted}
...
\begin{entry}{Minimum height}{minimum height}{Nodes}
\begin{code}
...
\begin{code}
\node[unspecified entity] (m) {};
\node[generic process, above left = 0.5cm of m] {};
\end{code}

\begin{code}
\node[unspecified entity] (m) {};
\node[generic process, below left = 2cm and 0.5cm of m] {};
\end{code}
...
\begin{code}
    \draw[interaction] (0,0) -- (2,0) node[outcome, pos = 0.7] (o) {};
\end{code}
...
\begin{code}
    \draw[interaction] (0,0) -- (2,0) node[outcome, pos = 0.3] (o1) {} node[outcome, pos = 0.5] (o2) {} node[outcome, pos = 0.7] (o3) {};
\end{code}
...
\begin{code}
\draw[interaction] (0,0) -- (2,0) coordinate[anchor point, pos = 0.5] (a);
\draw[stimulation] (1,1) -- (a);
\end{code}
...
\begin{code}
\draw[interaction] (0,0) -- (2,0);
\draw[stimulation] (1,1) -- (1,1 |- 2,0);
\end{code}
...
\begin{code}
\draw[interaction] (0,0) -- (2,0);
\draw[inhibition] (1,1) -- ($(1,1 |- 2,0)+(0,2pt)$);
\end{code}
...
\begin{code}
\draw[interaction] (0,0) -- (2,0) node[outcome, pos = 0.7] (o1) {};
\draw[interaction] let \p1=(o1) in (0,-2) -- (2,-2) coordinate[anchor point] (a) at (\x1,-2) node[outcome, pos = 0.3] (o2) {};
...
\begin{code}
\draw[interaction] (0,0) -- (2,0) node[outcome, pos = 0.7] (o1) {};
\draw[interaction] (-0.7,-0.5) -- (1.3,-0.5) node[outcome, pos = 0.7] (o2) {};
\draw[interaction] let \p1=(o1), \p2=(o2) in (0,-2) -- (2,-2) coordinate[anchor point] (a1) at (\x1,-2) coordinate[anchor point] (a2) at (\x2,-2);
