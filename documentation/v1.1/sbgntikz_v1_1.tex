...
\begin{itemize}
    \item in the directory of your \LaTeX{} source file or
    \item in your local \mintinline{bash}{texmf} directory, at \mintinline{bash}{texmf/tex/generic/pgf/}.
        The \mintinline{bash}{texmf} directory is usually located at \mintinline{bash}{/home/<user>/texmf/} under Linux, \mintinline{bash}{/Users/Library/texmf/} under MacOS, and \mintinline{bash}{C:/Users/<user>/texmf/} under Windows, but it can depend on your OS version and \TeX{} distribution. Your \mintinline{bash}{texmf} directory can sometimes be found using the \mintinline{bash}{kpsewhich -var-value=TEXMFHOME} command.
\end{itemize}
...
\begin{itemize}
    ...
    \item \mintinline[bgcolor=gray!10]{bash}{--tex-standalone=<OUTPUT FILE>}: writes the output \texttikz{} picture to a standalone tex file
