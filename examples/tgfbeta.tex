...
\begin{tikzpicture}[sbgn]
    ...
    \node[biological activity, anchor = center, right = 3cm of p63.center, align = center] (metastatic) {Metastatic\\suppressor\\genes\\activity};
    ...
    \node[biological activity, anchor = center, above = 3cm of platform.center] (tgfbeta) {TGF $\beta$};
